...
public class GankOthersPresenter implements GankOthersContract.Presenter {

    private GankApi gankApi;

    private RxSchedulers rxSchedulers;

    private GankOthersContract.View mView;

    public GankOthersPresenter(GankExtrasContract.View view) {
        this.mView = view;
