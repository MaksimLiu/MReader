 ...
 */
public class GankFrontEndFragment extends EventFragment implements GankCategoryContract.View{
    ...
    public void onResume() {
        ...
        if (bundle == null) {
            ...
            presenter.getGankCategoryDaily(GankContract.FRONT_END_CATEGORY, 1 + "");
...
//        recyclerView.setAdapter(new GankAdapter(getActivity(), new ArrayList<GankCategoryModel>()));
    ...
    private void loadMore() {
        ...
        page++;
        presenter.getGankCategoryDaily(GankContract.FRONT_END_CATEGORY, page + "");
