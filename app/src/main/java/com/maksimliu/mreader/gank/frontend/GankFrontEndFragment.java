 ...
 */
public class GankFrontEndFragment extends LazyLoadFragment implements GankCategoryContract.View, BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static GankFrontEndFragment newInstance() {
        return new GankFrontEndFragment();
    }
    ...
    public void showError(String errorMsg) {
        ...
        Snackbar.make(recyclerView, errorMsg, Snackbar.LENGTH_LONG).setAction(getString(R.string.retry), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mPresenter.fetchCategory(GankApi.FRONT_END_CATEGORY_TYPE, page);
            }
        });
