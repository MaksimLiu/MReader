...
public class GankCategoryModels {
    ...
    private List<GankCategoryBean> results;
    ...
    public List<GankCategoryBean> getResults() {
        return results;
    }

    public void setResults(List<GankCategoryBean> results) {
